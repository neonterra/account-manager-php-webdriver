...
<div class="card">
    ...
    <div class="card-body">
        <form action="{{ route("admin.accounts.update", [$product->id]) }}" method="POST" enctype="multipart/form-data">
            @csrf
            @method('PUT')
            ...
            <div class="form-group {{ $errors->has('description') ? 'has-error' : '' }}">
                <label for="description">{{ trans('global.account.fields.description') }}</label>
                ...
                @endif
                <p class="helper-block">
                    {{ trans('global.account.fields.description_helper') }}
                </p>
            </div>
            <div class="form-group {{ $errors->has('price') ? 'has-error' : '' }}">
                <label for="price">{{ trans('global.account.fields.price') }}</label>
                ...
                @endif
                <p class="helper-block">
                    {{ trans('global.account.fields.price_helper') }}
                </p>
            </div>
            <div>
